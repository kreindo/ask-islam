...
export async function POST(request: Request) {
  ...
  // Check daily message limit (10 messages per day for free users)
    ...
    return Response.json(
      {
        ...
        message: `You've reached your daily limit of ${DAILY_MESSAGE_LIMIT} messages. Please try again tomorrow.`,
